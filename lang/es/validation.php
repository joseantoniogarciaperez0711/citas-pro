...
return [
    ...
    | usados por la clase validadora. Algunas reglas tienen múltiples
    | versiones como las de tamaño. Siéntete libre de ajustarlas.
    |
    */
    ...
    'ascii' => 'El campo :attribute solo debe contener caracteres y símbolos alfanuméricos de un byte.',
    ...
    'decimal' => 'El campo :attribute debe tener :decimal dígitos decimales.',
    ...
    | atributos usando la convención "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Estas líneas se usan para reemplazar el placeholder :attribute por algo
    | más legible, como "Correo electrónico" en lugar de "email".
    |
    */
