...
<x-app-layout>
    ...
    <div class="py-8">
        ...
        <body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
            <div x-data="appData(@json($servicios ?? []), @json($categorias ?? []), @json($empleados ?? []))" x-cloak class="container mx-auto px-4 py-6 max-w-7xl">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 card-hover border border-white/20 fade-in">
                            <div class="flex justify-between items-start mb-4">
                                <div class="category-chip"
                                    :style="'background: linear-gradient(135deg, ' + getCategoryColorById(service
                                            .categoria_id) + ' 0%, ' + getCategoryColorById(service.categoria_id) +
                                        'CC 100%)'">
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <template x-if="service.empleado_id && !isEmployeeInactive(service.empleado_id)">
                                        <div class="flex items-center">
                                            <svg class="w-5 h-5 mr-3 text-purple-500" fill="none"
                            ...
                            <div class="flex gap-3">
                                <button @click="editService(service)"
                                    class="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-3 rounded-xl font-semibold transition-all duration-200 hover:shadow-lg hover:scale-[1.02] flex items-center justify-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button @click="deleteService(service.id)"
                                    class="flex-1 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-4 py-3 rounded-xl font-semibold transition-all duration-200 hover:shadow-lg hover:scale-[1.02] flex items-center justify-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="glass-effect rounded-2xl shadow-lg p-6">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="text-gray-600 text-sm">
                            Mostrando <span class="font-bold text-gray-900"
                                x-text="((currentPage - 1) * perPage) + 1"></span> -
                            <span class="font-bold text-gray-900"
                                x-text="Math.min(currentPage * perPage, filteredServices.length)"></span>
                            de <span class="font-bold text-gray-900" x-text="filteredServices.length"></span>
                            servicios
                        </div>
                ...
                <div x-show="showCategories" x-transition
                    ...
                    <div @click.stop
                        class="modal-content bg-white w-full sm:max-w-4xl sm:rounded-2xl max-h-screen overflow-hidden shadow-2xl">
                        ...
                        <div class="p-6 max-h-[80vh] overflow-y-auto">
                            <div class="flex justify-between items-center mb-6">
                                <div class="text-gray-600">
                                    Total: <span class="font-bold text-gray-900" x-text="categories.length"></span>
                                    categorías
                                </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                <template x-for="category in categories" :key="category.id">
                                    <div
                                        class="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 border border-gray-100 card-hover">
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                <div class="w-4 h-4 rounded-full pulse-dot"
                                                    :style="'background-color: ' + category.color"></div>
                                                <h4 class="font-bold text-gray-900" x-text="category.nombre"></h4>
                                            </div>
                                            <span class="category-chip"
                                                :style="'background: linear-gradient(135deg, ' + category.color + ' 0%, ' +
                                                    category.color + 'CC 100%)'">
                ...
                <div x-show="showServiceForm" x-transition
                    ...
                    <div @click.stop
                        class="modal-content bg-white w-full sm:max-w-lg sm:rounded-2xl max-h-screen overflow-y-auto shadow-2xl">
                        <div class="gradient-primary text-white p-6">
                        ...
                        <form @submit.prevent="saveService()" class="p-6 space-y-6">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-3">Nombre del
                                    servicio</label>
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <label class="text-sm font-semibold text-gray-700">Profesional</label>
                                <button type="button" @click="openNewEmployeeFromService()"
                                    class="text-blue-600 text-sm font-semibold hover:text-blue-700 transition-colors">
                                    + Nuevo empleado
                                </button>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input x-model.number="serviceForm.precio" type="number" required min="0"
                                        step="0.01"
                                        class="input-modern w-full px-4 py-4 rounded-xl text-gray-900 focus:outline-none">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-3">Duración
                                        (min)</label>
                                    <input x-model.number="serviceForm.duracion_minutos" type="number" required
                                        min="5" step="5"
                                        class="input-modern w-full px-4 py-4 rounded-xl text-gray-900 focus:outline-none">
                                </div>
                            </div>
                ...
                <!-- Modal Empleado - Reemplaza el modal de empleados actual -->
                    ...
                    <div @click.stop
                        ...
                        <div class="gradient-primary text-white p-6">
                            <div class="flex items-center justify-between">
                                ...
                                <button @click="closeEmployeeForm()"
                                    class="text-white hover:text-gray-300 p-2 rounded-lg hover:bg-white/10 transition-all">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M6 18L18 6M6 6l12 12" />
                        ...
                        <form @submit.prevent="saveEmployee()" class="p-6 space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-3">Puesto</label>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <label for="emp_activo" class="text-sm font-semibold text-gray-700">Empleado
                                    activo</label>
                            </div>
                            <div class="flex gap-3 pt-6">
                                ...
                                <button type="submit"
                                    class="flex-1 btn-primary text-white px-6 py-4 rounded-xl font-semibold">
                                    <span x-text="editingEmployee ? 'Actualizar' : 'Crear'"></span>
                                </button>
                            </div>
                        </form>
                    </div>
                        ...
                        <form @submit.prevent="saveCategory()" class="p-6 space-y-6">
                            ...
                            <div class="flex items-center gap-3">
                                <input x-model="categoryForm.activo" type="checkbox" id="activo"
                                    class="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="activo" class="text-sm font-semibold text-gray-700">Categoría
                                    activa</label>
                            </div>
                            <div class="flex gap-3 pt-6">
            ...
            <script>
                document.addEventListener('alpine:init', () => {
                    Alpine.data('appData', (serviciosBackend = [], categoriasBackend = [], empleadosBackend = []) => ({
                        ...
                        // form empleado (alta rápida) - con estado por defecto
                        employeeForm: {
                            nombre: '',
                            puesto: '',
                        ...
                        employees: (empleadosBackend || []).map(e => ({
                            ...e,
                        ...
                        getCategoryColorById(id) {
                            const c = this.getCategoryById(id);
                            return c ? (c.color || '#6366f1') : '#6366f1';
                        },
                        ...
                        async init() {
                            ...
                            try {
                                const re = await fetch('/app/empleados/lista', {
                                    headers: {
                                        'Accept': 'application/json'
                                    }
                                });
                                if (re.ok) {
                                    ...
                                    this.employees = (Array.isArray(de.empleados) ? de.empleados : []).map(
                                        e => ({
                                            ...e,
                                            activo: !!Number(e?.activo)
                                        }));
                        ...
                        async refreshCategories() {
                            try {
                                const resp = await fetch('/app/categorias', {
                                    headers: {
                                        'Accept': 'application/json'
                                    }
                                });
                                ...
                                this.categories = cats.map(c => ({
                                    ...c,
                                    servicios_count: c.servicios_count ?? this.services.filter(
                                        s => Number(s.categoria_id) === Number(c.id)).length
                                }));
                            } catch (e) {
                                console.error(e);
                        ...
                        closeCategoryForm() {
                            ...
                            } else if (this.returnToCategoriesList) {
                                this.returnToCategoriesList = false;
                                this.showCategories = true;
                            }
                        },
                        async saveCategory() {
                            try {
                                ...
                                const url = isEdit ? `/app/categorias/${this.editingCategory.id}` :
                                    `/app/categorias`;
                                ...
                                if (isEdit) {
                                    const idx = this.categories.findIndex(c => c.id === this.editingCategory
                                        .id);
                                    if (idx !== -1) this.categories[idx] = {
                                        ...data.categoria
                                    };
                                    ...
                                    // Seleccionar automáticamente en el servicio actual (igual que empleados)
                                    this.serviceForm.categoria_id = nueva.id;
                            ...
                            try {
                                ...
                                if (response.status === 409) {
                                    ...
                                    this.alertError(data.error ||
                                        'No se puede eliminar: tiene servicios vinculados.');
                                    return;
                                }
                        ...
                        editService(service) {
                            const categoriaId = service.categoria_id ?? (this.categories.find(c => c.nombre ===
                                service.categoria)?.id || '');
                        ...
                        async saveService() {
                            try {
                                ...
                                const url = isEdit ? `/app/servicios/${this.editingService.id}` :
                                    `/app/servicios`;
                                const method = isEdit ? 'PUT' : 'POST';
                                ...
                                if (isEdit) {
                                    const idx = this.services.findIndex(s => s.id === this.editingService
                                        .id);
                                    if (idx !== -1) {
                                        this.services[idx] = {
                                            ...this.services[idx],
                        ...
                        // ===== Empleados desde el modal de Servicio (igual que categorías) =====
                        openNewEmployeeFromService() {
                            this.returnToServiceForm = true;
                            this.showServiceForm = false;
                        ...
                        async saveEmployee() {
                            try {
                                ...
                                if (isEdit) {
                                    const idx = this.employees.findIndex(e => e.id === this.editingEmployee
                                        .id);
                                    if (idx !== -1) {
                                        this.employees[idx] = {
                                            ...this.employees[idx],
                                    ...
                                    // Seleccionarlo automáticamente en el servicio actual
                                    this.serviceForm.empleado_id = nuevo.id;
                                    this.toast('Empleado creado');
                                }

                                // Cerrar como lo hace categorías
                                this.closeEmployeeForm();
                            } catch (e) {
                                console.error(e);
                                this.alertError(e.message || 'Error al guardar empleado');
                            }
                        },
